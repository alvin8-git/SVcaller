process TRUVARI_BENCH {
    ...
    truvari bench -b ${truth_vcf} -c ${query_vcf} --includebed ${truth_bed} \\
        -o ${meta.id}.truvari_50_300  --passonly --pick multi --pctseq 0 --typeignore --sizemin 50   --sizemax 300   || true
    truvari bench -b ${truth_vcf} -c ${query_vcf} --includebed ${truth_bed} \\
        -o ${meta.id}.truvari_300_1k  --passonly --pick multi --pctseq 0 --typeignore --sizemin 300  --sizemax 1000  || true
    truvari bench -b ${truth_vcf} -c ${query_vcf} --includebed ${truth_bed} \\
        -o ${meta.id}.truvari_1k_10k  --passonly --pick multi --pctseq 0 --typeignore --sizemin 1000 --sizemax 10000 || true
    truvari bench -b ${truth_vcf} -c ${query_vcf} --includebed ${truth_bed} \\
        -o ${meta.id}.truvari_gt10k   --passonly --pick multi --pctseq 0 --typeignore --sizemin 10000               || true
